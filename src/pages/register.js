...
import gambarudang from "../gambar/gambarudang.png"; // Pastikan path gambar benar
import showicon from "../ikon/show.png";
import hideicon from "../ikon/hide.png";
import logo from "../ikon/icon.png"; // Pastikan path logo benar
    ...
    <div className="flex flex-col md:flex-row h-screen font-bold">
      ...
      <div className="w-full md:w-2/3 flex flex-col justify-center items-center bg-gray-100 py-8 md:py-0">
        <div className="w-11/12 md:w-3/4">
          <h2 className="text-3xl md:text-4xl mb-8 text-left">Register</h2>
          <form>
            {/* Username Field */}
            <div className="mb-4">
              <label
